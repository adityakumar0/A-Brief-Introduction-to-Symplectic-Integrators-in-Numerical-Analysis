%Non-symplectic second order built-in ode solver used for S.H.O
...
timerange=0:0.1:1000;
initialvalues=[1 0];
options=odeset('OutputFcn','odephas2');
ode23(@f,timerange,initialvalues,options)
[t,y]=ode23(@f,timerange,initialvalues);
